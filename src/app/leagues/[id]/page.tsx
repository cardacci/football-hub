    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="bg-gradient-to-r from-green-600 to-emerald-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <p className="text-green-100 mt-2">Season {CURRENT_SEASON}/{CURRENT_SEASON + 1}</p>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {error ? (
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-6">
            ...
            <ol className="list-decimal list-inside text-yellow-700 dark:text-yellow-300 space-y-2">
              ...
              <li>
                Add it to your <code className="bg-yellow-200 dark:bg-yellow-800 px-1 rounded">.env.local</code> file
              </li>
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
          ...
          <div className="flex flex-wrap gap-6 text-sm">
            ...
            <div className="flex items-center gap-2">
              <span className="w-5 h-5 bg-green-500 text-white text-xs font-bold flex items-center justify-center rounded">W</span>
              <span className="text-gray-600 dark:text-gray-400">Win</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-5 h-5 bg-gray-400 text-white text-xs font-bold flex items-center justify-center rounded">D</span>
              <span className="text-gray-600 dark:text-gray-400">Draw</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-5 h-5 bg-red-500 text-white text-xs font-bold flex items-center justify-center rounded">L</span>
